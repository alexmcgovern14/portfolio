  ...
  return (
    <div className="min-h-screen bg-[#2a2628] w-full overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-[25%_75%] gap-8 min-w-0 items-start project-detail-grid">
          <aside className="px-3 min-w-0">
          ...
          <main className="px-3 min-w-0 overflow-hidden">
